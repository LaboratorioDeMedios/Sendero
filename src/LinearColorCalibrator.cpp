...
bool LinearColorCalibrator::calculateCalibration() {
    ...
    long N = 9; // number of columns of A
    long NRHS = 1; // number of columns of b
    long LDA = 9; // number of rows of A
    long IPIV[9]; // pivot indices
    long LDB = 9; // number of rows of b
    long INFO = 0;
